  ...
  cl_request = service_pb2.PostModelOutputsRequest(
      ...
      inputs=[
          resources_pb2.Input(data=resources_pb2.Data(
              text=resources_pb2.Text(raw=prompt), image=resources_pb2.Image(base64=image))),
          resources_pb2.Input(data=resources_pb2.Data(text=resources_pb2.Text(raw=prompt2)))
      ],
  )
