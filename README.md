...
|                | [Using LiteLLM](models/model_predict/litellm_llm.py) | Use Litellm to call openAI-compatible models in Clarifai. See many more examples [here](models/model_predict/) |  |
